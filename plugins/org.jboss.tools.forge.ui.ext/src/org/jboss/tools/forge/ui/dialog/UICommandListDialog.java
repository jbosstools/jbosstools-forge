...
import org.jboss.tools.forge.ui.wizards.ForgeMultiStepWizard;
...
public class UICommandListDialog extends PopupDialog {
	...
	private void openWizard() {
		...
		ForgeWizard wizard = null;
		if (selectedCommand instanceof UIWizard) {
			wizard = new ForgeMultiStepWizard((UIWizard) selectedCommand,
					currentSelection);
		} else {
			wizard = new ForgeWizard(selectedCommand, currentSelection);
		}
